...
toilet -f future "TERMUX-CYBER" | lolcat
echo "-------------------------------------------------------" | lolcat                                                                      echo   "Author   : TERMUX-CYBER $white" |lolcat
echo   "Contact  : @itzHatrick $white" |lolcat
echo   "YouTube  : TERMUX-CYBER $white" |lolcat
echo   "Blog     : https://TERMUXCYBER.blogspot.com $white" |lolcat
echo "-------------------------------------------------------" | lolcat
echo "                           v2.0              " | lolcat                                                                                ###################################################
# CTRL + C
###################################################
...
00) echo "created by : TERMUX-CYBER" | lolcat
exit
;;
