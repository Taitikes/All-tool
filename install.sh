...
xdg-open https://youtube.com/@TERMUX-CYBERAMING4U
echo ""
...
echo "-------------------------------------------------------" | lolcat
echo   "Created  : TERMUX CYBER $white" |lolcat
echo   "Contact  : Instagram.com/ityourtaitikes $white" |lolcat
...
echo ""
echo "CODE_BY_TERMUX-CYBER" | lolcat
